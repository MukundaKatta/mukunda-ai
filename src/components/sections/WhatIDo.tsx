...
export function WhatIDo() {
  return (
    <section id="what-i-do" className="relative py-28 px-6 bg-[#f5f3ec] dark:bg-[#030308] overflow-hidden">
      ...
      <div className="absolute inset-0 hidden dark:block opacity-50">
        <MatrixRain density={0.55} opacity={0.11} />
      </div>
      {/* Radial vignette deepens edges so cards pop against matrix */}
