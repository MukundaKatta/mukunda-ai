...
export function Contact() {
  return (
    <section id="contact" className="relative py-28 px-6 overflow-hidden">
      {/* Gradient background */}
      <div className="absolute inset-0 bg-gradient-to-br from-teal-50 via-cyan-50 to-white dark:from-slate-900 dark:via-teal-950/20 dark:to-slate-950" />
        ...
        <ScrollReveal>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a
              ...
              className="flex items-center gap-2 px-8 py-3.5 rounded-full bg-teal-600 text-white font-semibold hover:bg-teal-700 transition-all duration-200 shadow-lg shadow-teal-600/25 hover:shadow-xl hover:shadow-teal-600/30 hover:-translate-y-0.5"
            >
