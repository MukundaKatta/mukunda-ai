    ...
    <section className="relative min-h-screen flex items-center justify-center px-6 py-20 gradient-mesh overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-16">
        ...
        <div className="relative shrink-0 animate-[fadeScale_0.8s_ease-out_both]">
          <div className="w-56 h-56 md:w-72 md:h-72 rounded-full glow-ring p-2 bg-gradient-to-br from-emerald-500 to-emerald-300">
          ...
          <div className="absolute -bottom-1 -right-1 w-11 h-11 bg-emerald-600 rounded-full flex items-center justify-center border-4 border-white dark:border-slate-950 shadow-lg">
        ...
        <div className="text-center md:text-left animate-[fadeSlide_0.8s_ease-out_0.15s_both]">
          <p className="text-lg text-slate-500 dark:text-slate-400 mb-3">
            Hi, I'm{' '}
            <a href={personal.github} target="_blank" rel="noopener" className="text-emerald-600 dark:text-emerald-400 font-semibold hover:underline">
              {personal.handle}
            </a>,
          </p>
          ...
          <div className="flex flex-wrap gap-3 justify-center md:justify-start mb-8">
            {personal.badges.map((badge) => (
              <span
                key={badge}
                className="px-4 py-2 rounded-full border border-slate-200 dark:border-slate-700 text-sm font-medium text-slate-600 dark:text-slate-300 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm hover:border-emerald-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-all duration-200"
              >
                {badge}
              </span>
            ))}
          ...
          <div className="flex gap-3 justify-center md:justify-start">
            {[
              ...
              <a
                ...
                target="_blank"
                rel="noopener"
                className="p-3 rounded-full border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 hover:border-emerald-400 hover:shadow-md transition-all duration-200 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm"
                aria-label={label}
              >
                {icon}
              </a>
